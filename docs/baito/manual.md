...
### 语音功能
触发指令：域宝骂我、nico、nico完整版、哈基米、曼波  

### 骰子
!> 可能和其他专用机器人冲突。如需禁止此功能，请管理员在群内发送`disable dice`
...
### 发病
!> 此功能饱受争议，如需禁止此功能，请管理员在群内发送`disable asill`
...
| 2生成今日词云 | 顾名思义 | - |
| 2生成昨日词云 | 顾名思义 | - |
| 我的月度总结 | 根据个人一个月内在群内的发言生成词云图 | - |
| 我的年度总结 | 根据个人一年内在群内的发言生成词云图 | - |
| 本群月度总结 | 根据群内所有成员在一个月内的发言生成词云图 | - |
| 本群年度总结 | 根据群内所有成员在一年内的发言生成词云图 | - |
| @域宝 重载词云配置 | SUPERUSER功能 | - |
